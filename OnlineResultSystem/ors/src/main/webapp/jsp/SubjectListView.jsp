<%@page import="in.co.rays.ors.model.SubjectModel"%>
...
<%@page import="in.co.rays.ors.ctl.SubjectListCtl"%>
...
<jsp:useBean id="model" class="in.co.rays.ors.model.SubjectModel" scope="request"></jsp:useBean>
<center>
<h1>Subject List</h1>
