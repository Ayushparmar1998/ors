...
<%@page import="in.co.rays.ors.model.TimetableModel"%>
<%@page import="in.co.rays.ors.ctl.TimetableListCtl"%>
...
<tr align="center">
  ...
  <%--  <label>Exam Date</label>
    <input type="text" name ="examdate" id="examdate" readonly="readonly"
        value="<%=DataUtility.getDateString(bean.getExamDate())%>" " placeholder="Enter Date"> --%>
