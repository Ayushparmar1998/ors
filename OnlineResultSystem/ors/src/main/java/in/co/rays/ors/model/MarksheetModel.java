	...
	public List search(MarksheetBean bean,int pageNo,int pageSize) throws ApplicationException{
		...
		try{
			...
			while(rs.next()){
                ...
                bean1.setStudentId(rs.getLong(3));
                bean1.setName(rs.getString(4));
                bean1.setPhysics(rs.getInt(5));
                bean1.setChemistry(rs.getInt(6));
                bean1.setMaths(rs.getInt(7));
                bean1.setCreatedBy(rs.getString(8));
                bean1.setModifiedBy(rs.getString(9));
                bean1.setCreatedDateTime(rs.getTimestamp(10));
                bean1.setModifiedDateTime(rs.getTimestamp(11));
			    list.add(bean1);
			}
			rs.close();
			pstmt.close();
