...
*/
    ...
    public static int getPageNo(HttpServletRequest request) {
    	...
    	return a;
    	//DataUtility.getInt((String)request.getAttribute("pageNo"));//(int) request.getAttribute("pageNo");
    }
    ...
    public static int getPageSize(HttpServletRequest request) {
        return (Integer)request.getAttribute("pageSize");//DataUtility.getInt((String)request.getAttribute("pageSize"));//(int) request.getAttribute("pageSize");
    }
