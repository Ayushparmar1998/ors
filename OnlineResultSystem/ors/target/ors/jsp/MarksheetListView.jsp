...
<%}else{ %>  
  <table width="100%" cellpadding="2px" cellspacing="-0.5px">
      ...
      <input type="text" name="name" value="<%=ServletUtility.getParameter("name", request)%>" " placeholder="Enter Student Name">
      <label>RollNo :</label> 
      <input type="text" name="rollNo" value="<%=ServletUtility.getParameter("rollNo", request)%>" " placeholder="Enter RollNo">
