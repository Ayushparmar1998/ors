 ...
 * Generated at: 2021-07-14 09:06:15 UTC
...
import in.co.controller.SubjectListCtl;
...
public final class SubjectListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("in.co.model.StudentModel");
    ...
    _jspx_imports_classes.add("in.co.model.SubjectModel");
    _jspx_imports_classes.add("in.co.util.ServletUtility");
    _jspx_imports_classes.add("in.co.controller.SubjectListCtl");
...
if(userLogged){
	...
	welcomeMsg = welcomeMsg+" , "+"Guest";
      ...
      out.write('\r');
      out.write('\n');
      in.co.bean.SubjectBean bean = null;
      bean = (in.co.bean.SubjectBean) _jspx_page_context.getAttribute("bean", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (bean == null){
        bean = new in.co.bean.SubjectBean();
        _jspx_page_context.setAttribute("bean", bean, javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      }
      out.write('\r');
      out.write('\n');
      in.co.model.SubjectModel model = null;
      model = (in.co.model.SubjectModel) _jspx_page_context.getAttribute("model", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (model == null){
        model = new in.co.model.SubjectModel();
...
if(bean.getId()==RoleBean.ADMIN){ 
      ...
      out.write("\r\n");
      out.write("   <td align=\"center\"><a>----</a></td>\r\n");
      out.write("  ");
} 
      out.write("\r\n");
      out.write("  \r\n");
