 ...
 * Generated at: 2021-08-13 21:46:06 UTC
...
import in.co.rays.ors.ctl.FacultyListCtl;
...
public final class FacultyListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("in.co.rays.ors.bean.FacultyBean");
    _jspx_imports_classes.add("in.co.rays.ors.util.DataUtility");
    _jspx_imports_classes.add("in.co.rays.ors.ctl.LoginCtl");
    _jspx_imports_classes.add("in.co.rays.ors.model.FacultyModel");
    _jspx_imports_classes.add("in.co.rays.ors.util.DataValidator");
    ...
    _jspx_imports_classes.add("in.co.rays.ors.bean.CollegeBean");
    _jspx_imports_classes.add("in.co.rays.ors.ctl.FacultyListCtl");
    _jspx_imports_classes.add("in.co.rays.ors.bean.CourseBean");
  }
...
if(userLogged){
	...
	welcomeMsg = welcomeMsg+" , "+"Guest";
      ...
      in.co.rays.ors.bean.FacultyBean bean = null;
      bean = (in.co.rays.ors.bean.FacultyBean) _jspx_page_context.getAttribute("bean", javax.servlet.jsp.PageContext.REQUEST_SCOPE);
      if (bean == null){
        bean = new in.co.rays.ors.bean.FacultyBean();
...
if(li==null || li.size()==0){
      ...
      out.write("  &nbsp;<label>SubjectName</label>\r\n");
      out.write("  <input type=\"text\" name = \"subjectName\" value=\"");
      out.print(ServletUtility.getParameter("subjectName", request));
      out.write("\" \" placeholder=\"Enter Subject Name\">\r\n");
      out.write("  &nbsp;<label>CollegeName</label>\r\n");
      out.write("  <input type=\"text\" name = \"collegeName\" value=\"");
