...
<%@page import="in.co.controller.TimetableCtl"%>
...
<tr>
    ...
    <td><input type="text" name ="examdate" id ="examdate" readonly="readonly"
    value="<%=DataUtility.getDateString(bean.getExamDate())%>" placeholder="Enter Exam Date">
