<%@page import="in.co.rays.ors.model.CollegeModel"%>
...
<%@page import="in.co.rays.ors.ctl.CollegeListCtl"%>
...
<%}else{ %> 
  ...
  <table width="100%" > 
   ...
   <td align ="center">
   <lable>NAME</lable>
   <input type="text" name ="cName" value="<%=ServletUtility.getParameter("cName", request) %>" " placeholder="Enter College Name">
   &nbsp;<label>CITY</label>
   <input type="text" name ="cCity" value=""<%=ServletUtility.getParameter("cCity", request) %>" " placeholder="Enter City">
