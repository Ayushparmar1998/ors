...
<%@page import="in.co.rays.ors.bean.CollegeBean"%>
<%@page import="in.co.rays.ors.bean.CourseBean"%>
<%@page import="in.co.rays.ors.ctl.FacultyListCtl"%>
...
<tr align="center">
    ...
    <input type="text" name = "fname" value="<%=ServletUtility.getParameter("fname", request)%>" " placeholder="Enter First Name">
  <%--  &nbsp;<label>LastName</label> 
   <input type="text" name = "lname" value="<%=ServletUtility.getParameter("lname", request)%>"> --%>
  &nbsp;<label>LoginId</label>
  <input type="text" name = "login" value="<%=ServletUtility.getParameter("login", request)%>" " placeholder="Enter Login Id">
  &nbsp;<label>SubjectName</label>
  <input type="text" name = "subjectName" value="<%=ServletUtility.getParameter("subjectName", request)%>" " placeholder="Enter Subject Name">
  &nbsp;<label>CollegeName</label>
  <input type="text" name = "collegeName" value="<%=ServletUtility.getParameter("collegeName", request)%>" " placeholder="Enter College Name">
  &nbsp;
